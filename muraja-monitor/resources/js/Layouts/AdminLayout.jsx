...
import {
    ...
    GitBranch, House, MagnifyingGlass, Medal, Megaphone,
    ShieldCheck, SignOut, Sword, UserCircle, UsersThree,
            ...
            <aside className="sidebar-desktop" style={{
                ...
                <div style={{ padding: '10px 8px', borderTop: '1px solid var(--sidebar-border)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 8px' }}>
                        ...
                        <Link href="/logout" method="post" as="button" style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--muted-foreground)', padding: '4px' }}>
                            <SignOut size={16} />
                        </Link>
                    </div>
                </div>
